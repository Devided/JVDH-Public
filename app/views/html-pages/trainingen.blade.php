    ...
    <div class="page_layout page_margin_top clearfix">
        <div class="page_header clearfix">
            <div class="page_header_left">
                <h1 class="page_title">Trainingen</h1>
            </div>
            ...
            <ul class="column">
                <li class="item_content clearfix">
                    <div class="text noicon">
                        <h3>
                            Verstelbaar														</h3>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid consequuntur dolorem et ipsa, laborum, numquam, porro possimus quam quod repudiandae sint suscipit tenetur voluptatem. Eveniet nihil quae tempore vel voluptatum?													</div>
                </li>
            </ul>
            <ul class="column">
                <li class="item_content clearfix">
